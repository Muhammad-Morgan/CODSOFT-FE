...
const Alljobs = () => {
    ...
    const getData = useCallback(
        async () => {
            startLoading()
            axios.get(`http://localhost:5000/getjobs`).then(({ data }) => {
                setJobList(data)
    ...
    const handleChange = (e) => {
        ...
        axios.get(`http://localhost:5000/filterjobs?position=${value}`).then(({ data }) => {
            setJobList(data)
        })
    }
    const handleStatus = (e) => {
        ...
        axios.put('http://localhost:5000/filterstatus', {
            status: value
        }).then(({ data }) => {
            setJobList(data)
        })
    ...
    const handleType = (e) => {
        ...
        axios.put('http://localhost:5000/filtertypes', {
            type: value
        }).then(({ data }) => {
            setJobList(data)
        })
 ...
 ${status === 'declined' ? 'var(--declined)' : ''}`,
                                            ...
                                            {/* <div className="d-flex mb-3 justify-content-start gap-3">
                                                <button
                                                    ...
                                                    className="my-newBtns text-center px-3">Apply</button>
